export const drivers = [
  ...
  },
  {
    ...
    biography: [
      ...
      'Bottas stepped it up a level in 2019, four victories securing a convincing second in the championship behind Hamilton, but that dropped to two wins to his team mates 11 in 2020. Now he must dig even deeper if he’s to regularly beat the man on the other side of the garage - and fend off the Red Bulls and Ferraris - and drive home as the fourth Finnish world champion.',
    ],
  },
  {
    firstName: 'Sergio',
  ...
  },
  {
    ...
    worldChampions: '4',
    biography: [
      'Born and raised a Bull, then a Prancing Horse, and now the face of Aston Martin’s Formula 1 revival, F1s poster boy of early achievement had won more than all but two drivers in history by the time he was just 26, including back-to-back world titles between 2010 and 2013.',
  ...
  },
  {
    ...
    biography: [
      ...
      'Tsunodas ascent to the top tier of motorsport has been astonishingly rapid: he’s gone from racing in Japanese F4 to a Formula 1 seat with AlphaTauri in just over three years, having arrived in Europe in 2019 with no knowledge of the circuits.',
  ...
  },
  {
    ...
    biography: [
      ...
      'FINALLY scored his first Williams points!',
  ...
  },
  {
    ...
    age: '22',
    DOB: '22/03/1999',
    POB: 'Vufflens-le-Château, Switzerland',
    podiums: '0',
    points: '0',
    worldChampions: '0',
    biography: [
  ...
  },
  {
    ...
    biography: [
      ...
      'That ascension into racings top category was largely thanks to his most impressive season to date in Formula 2 in 2019, with Latifi – who’d finished a disappointing ninth in the series’ 2018 standings – pulling up his bootstraps to claim second in the championship. That result, combined with the Williams/Robert Kubica union failing to mesh in 2019, meant Williams made the call to promote their affable Canadian reserve driver to a full-time drive alongside George Russell for 2020.',
...
export const renderableDriverInfo = drivers.map((driverInfo) => {
  const newDriver = {
    ...
    worldChampions: driverInfo.worldChampions,
    biography: driverInfo.biography,
  };
  return newDriver;
});

console.log(renderableDriverInfo, 'Im the renderable driver info');
